...
- Mean steps per day is **`r format(bydate.mean, nsmall=4)`**  
- Median steps per day is **`r format(bydate.median, nsmall=4)`**
...
Interval with maximum steps is **`r max_interval`**
...
Missing Data Count is **`r missingCount`**
...
- Mean steps per day **`r format(newbydate.mean, nsmall=4)`**. The new mean steps is `r descmean`  
- Median steps per day **`r format(newbydate.median, nsmall=4)`**. The new median steps is `r descmedian`
